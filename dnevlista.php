...
$sql="SELECT * FROM felhasz INNER JOIN osztaly ON felhasz.osztalyID=osztaly.id INNER JOIN evfolyam ON felhasz.evfolyamID = evfolyam.id INNER JOIN tanulasiidoszak ON felhasz.tanevekID = tanulasiidoszak.id WHERE rankID= 4 ORDER BY nev ASC , tanevekID DESC";
