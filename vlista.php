...
$sql="SELECT * FROM felhasz INNER JOIN osztaly ON felhasz.osztalyID=osztaly.id INNER JOIN tanulasiidoszak ON felhasz.tanevekID = tanulasiidoszak.id WHERE idoszak LIKE '2015%'";
